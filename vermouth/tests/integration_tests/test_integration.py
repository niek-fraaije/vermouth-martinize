...
@pytest.mark.parametrize("tier, protein", [
    ...
    # ['tier-1', 'bpti'],
    # ['tier-1', 'lysozyme'], martini30b32
    # ['tier-1', 'lysozyme_prot'], # not sure
    # ['tier-1', 'lysozyme_GO'], # PASS
    # ['tier-1', 'lysozyme_GObias'], # PASS
    # ['tier-1', 'lysozyme_ENbias'], # PASS
    # ['tier-1', 'villin'], # PASS
    # ['tier-1', '3i40'], # PASS
    # ['tier-1', '6LFO_gap'], # PASS
    # ['tier-1', '1mj5'], # not sure
    # ['tier-1', '1mj5-charmm'],
    # ['tier-1', 'EN_chain'],
    # ['tier-1', 'EN_region'],
    # ['tier-1', 'hst5'],
